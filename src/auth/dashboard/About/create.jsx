...
export default function AboutCreate() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const newAbout = await service.createAbout({ image: imageId, description });
            if (newAbout) {
                navigate("/dashboard/about"); // Redirect after creation
            }
        } catch (error) {
    ...
    return (
        <div className="flex justify-center mt-10">
            <div className="max-w-lg w-full bg-white shadow-lg rounded-lg p-6">
                <h2 className="text-2xl font-bold text-gray-800 mb-4">Create About</h2>
