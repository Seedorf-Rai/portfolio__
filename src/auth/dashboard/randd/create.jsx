...
function CreateRandD() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await service.createRandD(projectData);
            navigate("/dashboard/randd");
        } catch (error) {
    ...
    return (
        <div className="max-w-lg mx-auto p-6 bg-transparent rounded-lg shadow-md">
            <h2 className="text-2xl font-bold mb-4">Create a New Research and Development</h2>
